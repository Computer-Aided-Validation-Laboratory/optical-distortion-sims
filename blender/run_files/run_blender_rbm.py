...
base_dir = Path.cwd() / "blender/glass/rbm_blender_distortion_fixed"
...
scene.render_deformed_images(render_mesh=render_mesh2,
                             ...
                             part=window,
                             stage_image=False)
(base_dir / "images/blenderimage_0_0.tiff").rename(base_dir / "images/blenderimage_ud_0.tiff")
(base_dir / "images/blenderimage_0_1.tiff").rename(base_dir / "images/blenderimage_ud_1.tiff")
(base_dir / "images/blenderimage_1_0.tiff").rename(base_dir / "images/blenderimage_initial_0.tiff")
(base_dir / "images/blenderimage_1_1.tiff").rename(base_dir / "images/blenderimage_initial_1.tiff")
